                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group row width-100">
                                            <div class="col-7">
                                                <button type="button"
                                                    ...
                                                    <i></i>{{trans('lang.add_special_offer')}}</button>
                                            </div>
                                        </div>
                                        <div class="special_offer_div" style="display:none">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-primary add_more_sunday"
                                                            onclick="addMoreButton('Sunday','sunday', '1')">{{trans('lang.add_more')}}</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="restaurant_discount_options_Sunday_div restaurant_discount"
                                                ...
                                                <table class="booking-table" id="special_offer_table_Sunday">
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <label class="col-3 control-label">{{trans('lang.coupon_discount')}} {{trans('lang.type')}}</label>
                                                        </th>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-primary add_more_sunday"
                                                            onclick="addMoreButton('Monday','monday', '1')">{{trans('lang.add_more')}}</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-primary"
                                                            onclick="addMoreButton('Tuesday','tuesday', '1')">{{trans('lang.add_more')}}</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-primary"
                                                            onclick="addMoreButton('Wednesday','wednesday', '1')">{{trans('lang.add_more')}}</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-primary"
                                                            onclick="addMoreButton('Thursday','thursday', '1')">{{trans('lang.add_more')}}</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-primary"
                                                            onclick="addMoreButton('Friday','friday', '1')">{{trans('lang.add_more')}}</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-primary"
                                                            onclick="addMoreButton('Satuarday','satuarday','1')">{{trans('lang.add_more')}}</button>
                                                </div>
                                            </div>
