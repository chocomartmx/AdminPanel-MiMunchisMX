...
// var ref=[];
    ...
    /*var refuser = database.collection('users').where("role","in",["vendor"]);*/
    ...
    $(document).ready(function() {
        ...
        /*refuser.get().then( async function(snapshots){  

                snapshots.docs.forEach((listval) => {
                    var datas=listval.data();
                    try{
                        database.collection('users').doc(datas.id).update({'active':true}).then(function(result) {}); 
                    }catch(error){
